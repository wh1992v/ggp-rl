 ...
 *
 *
 * SampleHuiQL is a general gamer which applies the Q-Learning
 *
 ...
 *
 *
 * @author wanghui created in 05-12-2017 (dd-mm-yyyy)
 */

public class SampleHuiQL extends StateMachineGamer

{
...

	{
		...
		* Math.pow(2 * learningmatch, -1)) + 1) - 0.5;
		...
		/*RandomUtility ran = new RandomUtility();

		randomNumber = ran.nextDoubleRandom();*/
...

	{
		...
		// System.out.println(pertorecordlearningresult+","+matchcount);
